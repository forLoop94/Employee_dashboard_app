                ...
                <div className="text-[10px] font-bold mt-2">
                  ...
                  <div className="text-[10px] font-bold">
                    <div className="flex">
                      ...
                      <p>Address: <span className="font-light">{singleEmployee.contact.address}</span></p>
                    </div>
                    <div className="flex">
                      <FaPhoneAlt className="mt-0.5"/>
                      <p>Phone: <span className="font-light">{singleEmployee.contact.phone}</span></p>
                    </div>
                    <div className="flex">
                      <HiMail className="mt-0.5"/>
                      <p>Mail: <span className="font-light text-[8px]">{singleEmployee.contact.mail}</span></p>
                    </div>
                  </div>
                </div>
              </div>
